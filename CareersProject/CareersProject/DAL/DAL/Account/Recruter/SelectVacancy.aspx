<%@ Page Title="" Language="C#" MasterPageFile="~/Account/Recruter/Recruter.master" AutoEventWireup="true" CodeBehind="SelectVacancy.aspx.cs" Inherits="DAL.Account.Recruter.SelectVacancy" %>
            ...
            <div style="background-color:Gray; margin:3px; ">
                <table>
                    <tr>
                        ...
                        <td style="width:100px">
                            <asp:Label ID="lbSurname" runat="server" Text=<%# Eval("recruiter")%>></asp:Label>
                        </td>
                    </tr>
                </table>
            </div>
