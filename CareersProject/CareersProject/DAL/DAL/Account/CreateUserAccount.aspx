<%@ Page Title="" Language="C#" MasterPageFile="~/CareersMain.Master" AutoEventWireup="true" CodeBehind="CreateUserAccount.aspx.cs" Inherits="DAL.CreateUserAccount" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="Content" runat="server">
    <asp:MultiView ID="accMultiPage" runat="server" ActiveViewIndex="0">
        <asp:View ID="View1" runat="server">
            ...
            <br />
            <asp:Label ID="Label1" runat="server" Text="Fullname" Width="100px"></asp:Label>
            <asp:TextBox ID="txtName" runat="server"></asp:TextBox>
                &nbsp;<asp:RequiredFieldValidator ID="UserNameRequired" runat="server" 
                    ControlToValidate="txtName" ErrorMessage="Name is required." 
                    ToolTip="User Name is required." ValidationGroup="CreateUserWizard1">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Label2" runat="server" Text="Surname" Width="100px"></asp:Label>
            <asp:TextBox ID="txtSurname" runat="server"></asp:TextBox>
                &nbsp;<asp:RequiredFieldValidator ID="UserNameRequired1" runat="server" 
                    ...
                    ToolTip="User Name is required." ValidationGroup="CreateUserWizard1">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Label3" runat="server" Text="Nickname" Width="100px"></asp:Label>
            <asp:TextBox ID="txtNickname" runat="server"></asp:TextBox>
                ...
                &nbsp;<asp:RequiredFieldValidator ID="UserNameRequired2" runat="server" 
                    ...
                    ToolTip="User Name is required." ValidationGroup="CreateUserWizard1">*</asp:RequiredFieldValidator>
            <br />
            <asp:Label ID="Label4" runat="server" Text="ID" Width="100px"></asp:Label>
        ...
        <asp:View ID="View2" runat="server">
            <asp:CreateUserWizard ID="CreateUserWizard1" runat="server" 
                ...
                <MailDefinition BodyFileName="~/Utilities/EmailTemplates/createAccount.html" 
