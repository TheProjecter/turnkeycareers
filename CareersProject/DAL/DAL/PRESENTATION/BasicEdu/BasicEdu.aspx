<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="BasicEdu.aspx.cs" Inherits="careers.PRESENTATION.BasicEdu.BasicEdu" %>
...
<body>
    ...
    <div>
        <asp:Repeater ID="rptBasicEdu" runat="server" 
            ...
            <ItemTemplate>
                <asp:LinkButton Text=<%# Eval("school")%> ID="lbContact" 
                                CommandName="school" CommandArgument=<%# Eval("school")%> runat="server" PostBackUrl="~/PRESENTATION/BasicEdu/BasicEdu.aspx"></asp:LinkButton>
            </ItemTemplate>
            <SeparatorTemplate>
                <br />
            </SeparatorTemplate>
        ...
        <asp:LinkButton ID="lbtnNew" runat="server" onclick="lbtnNew_Click" 
            PostBackUrl="~/PRESENTATION/BasicEdu/BasicEdu.aspx" >New Address</asp:LinkButton>
    </div>
    <hr />
    <div>
