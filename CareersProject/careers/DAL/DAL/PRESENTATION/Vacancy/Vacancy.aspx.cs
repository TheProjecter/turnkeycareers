...
{
    public partial class Vacancy : System.Web.UI.Page, IVacancyView
    {
        ...
        protected void Page_Load(object sender, EventArgs e)
        {
            ...
            String recruter = "griddy";
            if (!IsPostBack)
            {
                presenter.loadPage(recruter);
        ...
        {
            if (startDate == Constants.Constants.DEFAULT_DATE_TIME)
            {
                txtStartDate.Text = "";
            }
            else
        ...
        {
            if (endDate == Constants.Constants.DEFAULT_DATE_TIME)
            {
                txtEndDate.Text = "";
            }
            else
        ...
        {
            if (viewCount == Constants.Constants.DEFAULT_INT)
            {
                txtViewCount.Text = "";
            }
            else
        ...
        {
            if (cost == Constants.Constants.DEFAULT_DOUBLE)
            {
        ...
        {
            Response.Redirect("~/PRESENTATION/Vacancy/Vacancy.aspx");
        }
