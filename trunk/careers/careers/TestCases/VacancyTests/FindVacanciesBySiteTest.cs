...
namespace TestCases
{
    ...
    /// <summary>
    ///This is a test class for FindVacanciesBySiteTest and is intended
    ///to contain all FindVacanciesBySiteTest Unit Tests
    ///</summary>
    [TestClass()]
    public class FindVacanciesBySiteTest
    {
        ...
        public void getVacanciesBySiteTest()
        {
            FindVacanciesBySite target = new FindVacanciesBySite();
            ...
            FindVacanciesBySite site = new FindVacanciesBySite();
            List<VacancyDTO> listVacs = site.getVacanciesBySite("Durban");
