...
namespace TestCases
{
    ...
    /// <summary>
    ///This is a test class for ExpiredVacanciesTest and is intended
    ///to contain all ExpiredVacanciesTest Unit Tests
    ///</summary>
    [TestClass()]
    public class ExpiredVacanciesTest
    {
        ...
        /// <summary>
        ///A test for getAllExpiredVancancies
        ///</summary>
        ...
        public void getAllExpiredVancanciesTest()
        {
            ExpiredVacancies target = new ExpiredVacancies();
            ...
            vacThree.manager = "Sam";
            vacThree.recruiter = "Tom";
            ...
            ExpiredVacancies get = new ExpiredVacancies();

            List<VacancyDTO> listVacs = get.getAllExpiredVancancies();
