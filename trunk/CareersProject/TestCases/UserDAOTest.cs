...
namespace TestCases
{
    ...
    public class UserDAOTest
    {
        ...
        public void UserDAOConstructorTest()
        {
            ...
            Assert.AreEqual(true,user_context.isFound("griddy") );

            ///*Update*/
            user.nickName = "willi";
            user_context.merge(user);
            Assert.AreEqual(user.nickName, user_context.find("griddy").nickName);

            ///*Delete*/
            user_context.removeByUserId("griddy");
            Assert.AreEqual(user_context.isFound("griddy"), false);
