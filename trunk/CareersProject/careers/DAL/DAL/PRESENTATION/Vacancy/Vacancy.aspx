<%@ Page Language="C#" AutoEventWireup="true" CodeBehind="Vacancy.aspx.cs" Inherits="careers.PRESENTATION.Vacancy.Vacancy" %>
    ...
    <div>
        ...
        <div>
            ...
            <asp:Repeater ID="rptQuestion" runat="server" 
                ...
                <ItemTemplate>
                    <asp:LinkButton Text=<%# Eval("question")%> ID="lbContact"
                                    CommandName="question" CommandArgument=<%# Eval("question")%> runat="server" PostBackUrl="~/PRESENTATION/Vacancy/Vacancy.aspx"></asp:LinkButton>
                </ItemTemplate>
                <SeparatorTemplate>
                    <br />
                </SeparatorTemplate>
            ...
            <asp:LinkButton ID="lbtnNewQuestion" runat="server" onclick="lbtnNewQuestion_Click" 
                PostBackUrl="~/PRESENTATION/Vacancy/Vacancy.aspx" >New Killer Question</asp:LinkButton>
        </div>
        ...
        <div>
            ...
            <asp:Repeater ID="rptKeyWord" runat="server" 
                ...
                <ItemTemplate>
                    <asp:LinkButton Text=<%# Eval("word")%> ID="lbContact"
                                    CommandName="word" CommandArgument=<%# Eval("word")%> runat="server" PostBackUrl="~/PRESENTATION/Vacancy/Vacancy.aspx"></asp:LinkButton>
                </ItemTemplate>
                <SeparatorTemplate>
                    <br />
                </SeparatorTemplate>
            ...
            <asp:LinkButton ID="lbtnNewKeyWord" runat="server" onclick="lbtnNewKeyWord_Click" 
                PostBackUrl="~/PRESENTATION/Vacancy/Vacancy.aspx" >New Key Word</asp:LinkButton>
        </div>
