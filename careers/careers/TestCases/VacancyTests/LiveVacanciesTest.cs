...
namespace TestCases
{
    ...
    /// <summary>
    ///This is a test class for LiveVacanciesTest and is intended
    ///to contain all LiveVacanciesTest Unit Tests
    ///</summary>
    [TestClass()]
    public class LiveVacanciesTest
    {
        ...
        /// <summary>
        ///A test for getAllLiveVancancies
        ///</summary>
        ...
        public void getAllLiveVancanciesTest()
        {
            LiveVacancies target = new LiveVacancies(); // TODO: Initialize to an appropriate value
            ...
            vacThree.manager = "Marc";
            vacThree.recruiter = "Mandy";
