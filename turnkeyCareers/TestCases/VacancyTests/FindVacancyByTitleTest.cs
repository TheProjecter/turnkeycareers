...
namespace TestCases
{
    ...
    /// <summary>
    ///This is a test class for FindVacancyByTitleTest and is intended
    ///to contain all FindVacancyByTitleTest Unit Tests
    ///</summary>
    [TestClass()]
    public class FindVacancyByTitleTest
    {
        ...
        /// <summary>
        ///A test for getVacanciesByTitle
        ///</summary>
        ...
        public void getVacanciesByTitleTest()
        {
            FindVacancyByTitle target = new FindVacancyByTitle();
            ...
            FindVacancyByTitle title = new FindVacancyByTitle();
            VacancyDTO titleVac = title.getVacanciesByTitle("3");
            string vacNo = titleVac.title;
            Assert.AreEqual(vac_context.isFound("3"),true);
