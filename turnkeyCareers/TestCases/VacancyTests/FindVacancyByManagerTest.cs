...
namespace TestCases
{
    ...
    /// <summary>
    ///This is a test class for FindVacancyByManagerTest and is intended
    ///to contain all FindVacancyByManagerTest Unit Tests
    ///</summary>
    [TestClass()]
    public class FindVacancyByManagerTest
    {
        ...
        public void getVacanciesByManagerTest()
        {
            FindVacanciesByManager target = new FindVacanciesByManager();
            ...
            FindVacanciesByManager manager = new FindVacanciesByManager();

            List<VacancyDTO> listVacs =  manager.getVacanciesByManager("Tom");
